    ...
    <div class="foods">
        <div class="card" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="discription">
                <h1>Adobo</h1>
                <p style="font-weight: 300">A classic Filipino dish made with meat marinated in vinegar, soy sauce, garlic, and spices. <br><br>
                <strong style="font-weight: bold">Health Benefits:</strong><br> Vinegar aids digestion, garlic supports heart health, and protein-rich meat helps build muscles.</p>
            </div>
        </div>
        <div class="card" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
            ...
            <div class="discription">
                <h1>Sinigang</h1>
                <p style="font-weight: 300">A tangy and savory soup made with tamarind, vegetables, and meat or seafood. <br><br>
                <strong style="font-weight: bold">Health Benefits:</strong><br> Rich in vitamin C, fiber, and antioxidants, Sinigang boosts immunity and aids digestion.</p>
            </div>
        </div>
        <div class="card" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
            ...
            <div class="discription">
                <h1>Kare-Kare</h1>
                <p style="font-weight: 300">A rich peanut stew with oxtail, tripe, and vegetables, often served with bagoong. <br><br>
                <strong style="font-weight: bold">Health Benefits:</strong><br> Peanuts provide healthy fats and protein, while vegetables supply fiber and vitamins.</p>
            </div>
        </div>
        <div class="card" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
            ...
            <div class="discription">
                <h1>Halo-Halo</h1>
                <p style="font-weight: 300">A colorful dessert with shaved ice, fruits, jellies, and milk. <br><br>
                <strong style="font-weight: bold">Health Benefits:</strong><br>Ube is rich in antioxidants, fruits provide vitamins, and dairy offers calcium.</p>
            </div>
        </div>
    </div>
    </section>
